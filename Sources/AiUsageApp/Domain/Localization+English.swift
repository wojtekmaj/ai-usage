extension TranslationCatalog {
    static let english: [L10nKey: String] =
        [
            ...
            .showCodexCredits: "Show credits",
            .showCodexLimitResets: "Show limit resets",
            .showCodexSparkUsage: "Show GPT-5.3-Codex-Spark usage",
            .optionalMetricAlways: "Always",
            .optionalMetricOnlyWhenAboveZero: "Only when above 0",
            .optionalMetricNever: "Never",
